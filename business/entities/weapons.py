...
class Weapon():
    ...
    def __init__(self, bullet_name: str, shoot_cooldown: int, bullet_speed: float, bullet_damage: int, required_level: int):
...
class PistolWeapon(Weapon):
    ...
    def __init__(self):
        super().__init__("PistolBullet", shoot_cooldown=500,
                         bullet_speed=5.0, bullet_damage=10, required_level=1)
...
class ShotgunWeapon(Weapon):
    ...
    def __init__(self):
        super().__init__("ShotgunBullet", shoot_cooldown=600,
                         bullet_speed=4.0, bullet_damage=10, required_level=5)
...
class MinigunWeapon(Weapon):
    ...
    def __init__(self):
        super().__init__("MinigunBullet", shoot_cooldown=100,
                         bullet_speed=6.0, bullet_damage=8, required_level=10)
